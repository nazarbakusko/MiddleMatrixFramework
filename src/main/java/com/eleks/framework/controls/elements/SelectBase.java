...
public class SelectBase extends ControlBase implements Select {

    private final org.openqa.selenium.support.ui.Select innerSelect;

    public SelectBase(WebElement element) {
        super(element);
...
//        List<WebElement> selectElement = findElements(By.xpath(locator));
//        Select selectObject = new Select(selectElement);
//        selectObject.selectByVisibleText(page);
